...
function _openShareQrModal({ title = 'Svita', subtitle = '', shareUrl = '' } = {}) {
  ...
  modal.innerHTML = `
    <div style="width:min(420px,96vw);background:#fffdf8;border:1px solid var(--border);border-radius:18px;box-shadow:0 24px 80px rgba(0,0,0,.24);padding:16px 16px 14px">
      ...
      <div style="display:flex;justify-content:center;padding:10px 0 12px">
        <img src="${_qrImageUrl(shareUrl)}" alt="Svita QR" style="width:min(280px,78vw);height:auto;border-radius:14px;border:1px solid var(--border);background:#fff">
      </div>
