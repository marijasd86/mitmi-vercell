  ...
  modal.innerHTML = `
    <div style="width:min(420px,96vw);background:#fffdf8;border:1px solid var(--border);border-radius:18px;box-shadow:0 24px 80px rgba(0,0,0,.24);padding:16px 16px 14px">
      ...
      <div style="display:flex;justify-content:center;padding:10px 0 12px;flex-direction:column;align-items:center;gap:8px">
        <div style="width:min(280px,78vw);min-height:160px;border-radius:14px;border:1px dashed var(--border2);background:var(--bg2);display:flex;align-items:center;justify-content:center;padding:16px;text-align:center;font-size:12px;color:var(--ink3);line-height:1.5">
          ${_langText('QR otvori preko dugmeta ispod (u novom tabu), zbog sigurnosnih ograničenja u aplikaciji.', 'Open the QR using the button below (new tab) due to in-app security restrictions.')}
        </div>
      </div>
