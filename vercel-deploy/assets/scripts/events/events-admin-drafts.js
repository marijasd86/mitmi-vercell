...
async function simulateAiImport() {
  ...
  try {
    ...
    showToast('Link draft trenutno nije sačuvan. Proveri bazu i pokušaj ponovo.', 'error', 2400);
  }
}
