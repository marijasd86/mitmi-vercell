...
(() => {
  const ensureLandingHeroVideoPlayback = () => {
    ...
    const tryPlay = () => {
      ...
      if (playPromise && typeof playPromise.catch === 'function') {
        playPromise.catch((err) => {
          console.warn('[mitmi] landing hero video play blocked:', err);
        });
      }
    };
  ...
  ensureLandingHeroVideoPlayback();
  document.addEventListener('DOMContentLoaded', applyMitmiHeroCopyNow);
  document.addEventListener('DOMContentLoaded', ensureLandingHeroVideoPlayback);
