...
async function _loadPlanNotificationItems() {
  ...
  try {
    ...
    console.warn('[mitmi] _loadPlanNotificationItems:', e.message);
    return [];
  }
}
...
async function _resolveDirectPeerFromChat(chatId = '') {
  ...
  try {
    ...
    console.warn('[mitmi] _resolveDirectPeerFromChat:', e.message);
    return null;
  }
}
...
async function _resolveChatMeta(chatId = '') {
  ...
  try {
    ...
    console.warn('[mitmi] _resolveChatMeta:', e.message);
    return null;
  }
}
