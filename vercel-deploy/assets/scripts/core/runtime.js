...
async function handleCreateInvite() {
  ...
  try {
    const isManagedCreate = !_editingEventId && !_inviteEventId && _createFlowMode === 'managed';
    const managedOrganizer = _createFlowMode === 'managed' ? await _getMyClaimedOrganizer() : null;
    const myVenue = _createFlowMode === 'managed' ? await _getMyVenue().catch(() => null) : null;
