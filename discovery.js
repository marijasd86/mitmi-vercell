...
function ttLoadCard(data) {
  if (!data) {
    ...
    set('tt-cat', '📅 Otkrij');
    set('tt-title', 'Još nema događaja za swipe');
    set('tt-meta', 'Objavi ili sačuvaj prve događaje da popuniš discovery.');
    set('tt-date', 'Dogadjaji će stizati ovde');
    set('tt-desc', 'Kada događaji postanu aktivni, ovde ćeš moći brzo da istražuješ i sačuvaš ono što ti se dopada.');
    set('tt-going-txt', 'Swipe će se aktivirati čim stignu prvi događaji');
